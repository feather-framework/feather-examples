...
[
    ...
    .enableExperimentalFeature("AvailabilityMacro=hummingbirdSpecExamples 1.0:macOS 15.0, iOS 18.0, tvOS 18.0, watchOS 11.0, visionOS 2.0"),
]
...
let package = Package(
    name: "hummingbird-spec-examples",
    platforms: [
        .macOS(.v15),
        .iOS(.v18),
        .tvOS(.v18),
