...
let package = Package(
    ...
    products: [
        .executable(name: "ValidationExamples", targets: ["ValidationExamples"]),
    ],
    dependencies: [
        .package(url: "https://github.com/feather-framework/feather-validation", branch: "main"),
    ...
    targets: [
        ...
        .testTarget(
            name: "ValidationExamplesTests",
            dependencies: [
                .target(name: "ValidationExamples"),
