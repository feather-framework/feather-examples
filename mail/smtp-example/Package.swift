...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/feather-framework/feather-mail-smtp", exact: "1.0.0-beta.4"),
        .package(url: "https://github.com/feather-framework/feather-mail-ephemeral", from: "1.0.0-beta.2"),
